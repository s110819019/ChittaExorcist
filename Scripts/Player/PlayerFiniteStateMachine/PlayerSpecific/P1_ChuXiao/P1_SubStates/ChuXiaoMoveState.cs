...
{
    public class ChuXiaoMoveState : ChuXiaoGroundedState<PlayerMoveStateData>
    {
        public ChuXiaoMoveState(string animationBoolName, ChuXiaoPlayer player) : base(animationBoolName, player)
        {
            // 1. Idle
        }
        ...
        {
            base.Enter();
            // Player.PlayerHolder.PlayPlayerWalkParticle(true);
            Player.PlayerHolder.PlayPlayerWalkSmokeEffectLoop();
        ...
        {
            base.Exit();
            // Player.PlayerHolder.PlayPlayerWalkParticle(false);
            Player.PlayerHolder.StopPlayPlayerWalkSmokeEffect();
