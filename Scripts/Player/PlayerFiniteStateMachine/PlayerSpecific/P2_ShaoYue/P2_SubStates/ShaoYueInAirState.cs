...
{
    public class ShaoYueInAirState : ShaoYuePlayerState<PlayerInAirStateData>
    {
        public ShaoYueInAirState(string animationBoolName, ShaoYuePlayer player) : base(animationBoolName, player)
        {
            // 1. Land
            // 2. Jump
        }
        ...
        private void CheckVariableJumpHeight()
        {
            ...
            // y 速度為 0 即為非跳躍中
            // TODO: 在楚霄跳躍時切換成韶月的跳躍狀態會跳不起來(<= 0.01f)
        ...
        public override void LogicUpdate()
        {
            ...
            else if (_isGrounded && Movement.CurrentVelocity.y < 0.01f && !_isJumping)
            {
                // Land
                // TODO: 可能太複雜
            ...
            else if (_attackInput && PlayerManaStats.CheckManaCost(Player.AirLightAttackState.Ability.ManaRequireCost()))
            {
