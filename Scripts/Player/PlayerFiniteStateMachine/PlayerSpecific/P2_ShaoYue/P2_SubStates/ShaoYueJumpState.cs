...
{
    public class ShaoYueJumpState : ShaoYueAbilityState<PlayerJumpStateData>
    {
        public ShaoYueJumpState(string animationBoolName, ShaoYuePlayer player) : base(animationBoolName, player)
        {
            // To In Air
        }
